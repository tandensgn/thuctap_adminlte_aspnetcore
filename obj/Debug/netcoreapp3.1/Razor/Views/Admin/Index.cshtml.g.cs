#pragma checksum "D:\ThucTap\CongTyGiao\AdminLTEinASPNETCoreMVC\AdminLTEASPNETEmployees\Views\Admin\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ec69926ca251820fbe10a23bc67cf6e4132c697a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ec69926ca251820fbe10a23bc67cf6e4132c697a", @"/Views/Admin/Index.cshtml")]
  ...
  ");
        ...
        $('#edit-e').submit(function (e) {
            ...
            ");
                ...
                highlight: function (element, er");
                WriteLiteral(@"rorClass, validClass) {
                    $(element).addClass('is-invalid');
                },
                unhighlight: function (element, errorClass, validClass) {
                    $(element).removeClass('is-invalid');
            ...
            if ($('#password-p').valid()) {
                ...
                WriteLiteral(@"his.action,
                        ...
                        success: function (response) {
                            ...
                            defaultModal($(""#modal-defa");
                WriteLiteral(@"ult""), 'Change Password', 'Change password successfully!');
                            $(""#modal-default"").modal('show');
                        },
                        error: function (xhr, error, status) {
                            defaultModal($(""#modal-default""), error, status);
