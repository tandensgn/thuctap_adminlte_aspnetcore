#pragma checksum "D:\ThucTap\CongTyGiao\AdminLTEinASPNETCoreMVC\AdminLTEASPNETEmployees\Views\Admin\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "18bbef3deefd9e8f533169a97b5dc4713fed88a0"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"18bbef3deefd9e8f533169a97b5dc4713fed88a0", @"/Views/Admin/Index.cshtml")]
...
#nullable disable
  ...
  ");
                WriteLiteral(@"          modal.find('.modal-body #EmpUsername').val(EmpUsername)
        ...
        $('#modal-password').on('show.bs.modal', function (event) {
            ...
            //modal.find
            modal");
                WriteLiteral(@".find('.modal-title').text('Password')
            modal.find('.modal-body #EmpId').val(EmpId)
            modal.find('.modal-body #EmpPass').val(EmpPass)
            ...
            $('#edit-e').validate({
                ...
                messages: {
                    ...
                    EmpUsername: {
                        ...
                        minlength: """);
                WriteLiteral(@"Username must be longer than 6 characters""
                    },
  ...
  ");
        ...
        $('#password-p').submit(function (p) {
            ...
            if ($('#password-p').valid()) {
                ...
                if (Pass_em != CofPass_em) {
                    ...
                    $("".modal-footer ");
                WriteLiteral(@"#btn-password"").attr(""disabled"", true);
                ...
                WriteLiteral(@";
                            ...
                            defaultModal($(""#modal-default""), 'Chỉnh sửa thông tin thành công');
             ...
             ");
                ...
                messages: {
                    ...
                    EmpPhone: {
                        ...
                        minlength: ""Phone numbers must have 10 valid numbers"",
                        maxlength: ""Ph");
                WriteLiteral(@"one numbers must have 10 valid numbers"",
                        digits: ""Phone numbers must have 10 valid numbers""
                    },
                    EmpAddress: {
                        required: ""Enter address""
        ...
        $('#delete-d').click(function (d) {
            ...
            $("".modal-footer #delete-emp"").prepend('<span clas");
                WriteLiteral(@"s=""spinner-border spinner-border-sm"" role=""status"" aria-hidden=""true""></span>')
